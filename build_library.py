...
# my_library.add('God Emperor of Dune', "Frank Herbert")
# my_library.add('Sword of Truth', "Terry Goodkind")
# my_library.add('Sharp Objects', "Gillian Flynn")
...
# print(type(my_library.count_books()))
...
# nyt_bestsellers.add_title('Long Live the Pumpkin Queen', 'Shea Ernshaw')
# nyt_bestsellers.add_title('Long Shadows', 'David Baldacci')
# nyt_bestsellers.add_title(
#     'asking for a friend', 'Testing sort case insensitive')
